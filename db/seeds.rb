...
Payment.create(amount: 1003, payee_id: 1, payer_id: 2)
Payment.create(amount: 1515, payee_id: 1, payer_id: 3)
Payment.create(amount: 2020, payee_id: 1, payer_id: 4)
Payment.create(amount: 199, payee_id: 5, payer_id: 1)
Payment.create(amount: 12345, payee_id: 6, payer_id: 1)