...
Expense.create(name: "One dinner", amount: 5442, owner_id: 1, date: "2020-04-25", split:[2, 3, 4])
Expense.create(name: "Two dinner", amount: 2022, owner_id: 1, date: "2020-04-18", split: [5, 6])
Expense.create(name: "Three dinner", amount: 3099, owner_id: 1, date: "2020-04-08", split: [7, 9])
Expense.create(name: "Four dinner", amount: 4016, owner_id: 1, date: "2020-04-01", split: [6, 2])
Expense.create(name: "Five dinner", amount: 5090, owner_id: 1, date: "2020-04-20", split: [4, 2])
Expense.create(name: "Expense 6", amount: 3698, owner_id: 2, date: "2020-05-04", split: [5, 7])
Expense.create(name: "Expense 7", amount: 1234, owner_id: 2, date: "2020-03-29", split: [1])
Expense.create(name: "Expense 8", amount: 98760, owner_id: 2, date: "2019-04-29", split: [1, 7, 4, 3])
Expense.create(name: "Expense 9", amount: 9420, owner_id: 5, date: "2018-04-29", split: [4, 1, 6])

# Transaction.create(amount: 2721, payer_id: 2, expense_id: 1)
# Transaction.create(amount: 1011, payer_id: 2, expense_id: 2)
# Transaction.create(amount: 1549, payer_id: 3, expense_id: 3)
...
# Transaction.create(amount: 1004, payer_id: 4, expense_id: 4)
# Transaction.create(amount: 1004, payer_id: 3, expense_id: 4)
# Transaction.create(amount: 1004, payer_id: 2, expense_id: 4)
